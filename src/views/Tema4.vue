  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-contenido(data-aos="flip-up")
      .titulo-principal__numero
        span 4
      h1 Gestión integral de residuos en salud
    p(data-aos="fade-right") El Decreto 351 de 2014 (febrero 19), reglamenta la gestión integral de los residuos generados en la atención en salud y otras actividades. Aplica a personas naturales o jurídicas, públicas o privadas que generen, identifiquen, separen, empaquen, recolecten, transporten, almacenen, aprovechen, traten o dispongan, finalmente, los residuos generados en desarrollo de las actividades relacionadas con atención en salud y acciones relacionadas.
    p(data-aos="fade-right") Se presenta la lista de actividades, relacionadas o conexas con servicios de salud, que han de prestar especial atención a las orientaciones para la gestión integral de los residuos en salud:
    ...
    .row.mb-5
      p(data-aos="fade-right") El sistema integral contiene aspectos como generación, separación, transporte interno, almacenamiento intermedio o central, desmantelamiento (control interno), recolección, transporte externo, desactivación o desnaturalización o disposición final (control externo).
      p(data-aos="fade-right") En la tabla 2, se puede comprender y asimilar las características de almacenamiento de residuos derivados de los servicios de salud, hospitalarios y similares.
    .titulo-sexto.color-acento-contenido.mb-5(data-aos="fade-left")
      p.mb-0 #[b Tabla 2]. Almacenamiento de residuos hospitalarios y similares.
    .tabla-a.color-secundario(data-aos="fade-down")
      table(alt="Esta tabla indica todo lo que se debe tener en cuenta con el almacenamiento de residúos hospitalarios")
        thead
          tr
            th 
            th Almacenamiento de residuos hospitalarios y similares
            th 
        tbody
          tr
            td <b>Almacenamiento intermedio</b>
            td Sitios ubicados en diferentes lugares del generador. Destinados a depósito temporal (el menor posible) de residuos, antes de la recolección interna. Áreas de acceso restringido y señalizadas.
            td 
              ul.lista-ul--color.fa-ul2
                li
                  i.fas.fa-circle.fa-xs.color-vineta1
                  | Cubierto.
                li 
                  i.fas.fa-circle.fa-xs.color-vineta1
                  | Iluminado.
          ...
          tr
            td <b>Almacenamiento central</b>
            td Sitio temporal de estancia de los residuos para posterior entrega a empresa de aseo. Ubicado dentro de la institución, aislado del edificio y servicios prestados.
            td 
              ul.lista-ul--color.fa-ul2
                li 
                  i.fas.fa-circle.fa-xs.color-vineta1
                  | Espacios por clase de residuos.
                li 
                  i.fas.fa-circle.fa-xs.color-vineta1
                  | Con acceso para vehículos recolectores.
                li 
                  i.fas.fa-circle.fa-xs.color-vineta1
                  | Báscula y registro de control.
                li 
                  i.fas.fa-circle.fa-xs.color-vineta1
                  | Exclusivo para residuos hospitalarios y similares.
          tr
            td <b>Almacenamiento de residuos químicos</b>
            td El almacenamiento de sustancias residuales químicas, incluyendo los de medicamentos y fármacos.
            td 
              ul.lista-ul--color.fa-ul2
                li 
                  i.fas.fa-circle.fa-xs.color-vineta1
                  | Identificadas previamente al almacenamiento.
                li 
                  i.fas.fa-circle.fa-xs.color-vineta1
                  | Manipulación separada entre residuos incompatibles.
                li 
                  i.fas.fa-circle.fa-xs.color-vineta1
                  | Conocer factores que alteran el estado del residuo: humedad, calor y tiempo.
    separador
    #t_4_3.titulo-segundo.color-acento-contenido
      h2 4.3  Segregación en la fuente
    .row.align-items-center.mb-4(data-aos="fade-right")
      .col-3.col-lg-1.d-none.d-lg-block
        figure 
    ...
    AcordionA(tipo="a" clase-tarjeta="tarjeta tarjeta--azul4")(data-aos="fade-down").mt-5
    ...
    .row.justify-content-center.align-items-center.tema4-bg2.p-4.p-lg-2.mb-5
    ...
    p(data-aos="fade-right") Se entiende por <b>“residuos peligrosos”</b> a los residuos que debido a su peligrosidad específica (tóxico, corrosivo, reactivo, inflamable, explosivo, infeccioso, eco tóxico), pueden causar daños a la salud de los seres vivos o al ambiente.
    p(data-aos="fade-right") A continuación, algunas claridades conceptuales de suma importancia para profundizar en este tema:
