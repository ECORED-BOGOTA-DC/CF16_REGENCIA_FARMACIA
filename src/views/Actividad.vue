  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        ...
        p.mb-4 Identificar los conceptos para desarrollar una actitud de servicio efectiva en base a mejorar la presentación personal y generar un impacto positivo tanto en la satisfacción del cliente como en el entorno laboral.
